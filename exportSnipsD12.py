...
def writeJupyterLab(scopeJupyterLab, args):
    ...
    withou LaTeX in the name for use in Python.
    ...
    26 April 2020
    """
    home1 = '/Users/blaine/Manuscripts/CCTBXsnippets/cctbxsnips/jupyterlabcctbxsnips/'
    selected = args
    c.execute('SELECT DISTINCT category FROM {} WHERE {cn}="source.python" ORDER BY category'.format(
        table_name, cn=col_3))
    distinct = c.fetchall()
...
if __name__ == '__main__':
    ...
    home1 = r'/Users/blaine/Manuscripts/CCTBXsnippets/'
    home2 = r'cctbxsnips/'
